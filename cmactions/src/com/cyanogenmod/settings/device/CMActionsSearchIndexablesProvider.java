...
public class CMActionsSearchIndexablesProvider extends SearchIndexablesProvider {
    private static final String TAG = "CMActionsSearchIndexablesProvider";
    ...
    public Cursor queryXmlResources(String[] projection) {
        ...
        cursor.addRow(generateResourceRef(new SearchIndexableResource(1, R.xml.gesture_panel,
                    GestureSettings.class.getName(),
                    R.drawable.ic_settings_gestures)));

        cursor.addRow(generateResourceRef(new SearchIndexableResource(1, R.xml.fp_gesture_panel,
                    FPGestureSettings.class.getName(),
        ...
        cursor.addRow(generateResourceRef(new SearchIndexableResource(1, R.xml.screen_off_gesture_panel,
                    ScreenOffGestureSettings.class.getName(),
